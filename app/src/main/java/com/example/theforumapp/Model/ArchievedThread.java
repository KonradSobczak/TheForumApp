...
public class ArchievedThread {
    ...
    public ArchievedThread(String id, String issueTitle, String deviceModel, String binary, String issueType, String occurrence, String description, String customerId, String engineerId, String osVersion, String salesCode, String serialNumber, String downloadUri1, String downloadUri2, String downloadUri3, String resolution, String customerName, String engineerName) {
            this.id = id;
